  ...
  <div class="app">
      ...
      <div class="form">
        ...
        <div class="cont">
          <div class="part1">
            ...
            <div class="cont_inputs">
              <label for="apellido">Parcela</label>
              <select class="input" v-model="parcelas">
                <option
                  v-for="parcelas in parcela"
                  :key="parcelas"
                  :value="parcelas"
                >
                  {{ parcelas.Numero }}
          ...
          <div class="part2">
            <div class="cont_inputs">
              <label for="Tipo">Estado Suelo</label>
              <select class="input" v-model="Estado_Suelo">
            ...
            <div class="cont_inputs">
              ...
              <button class="btnAbrir" @click="abrir()">{{ produc }}</button>
            </div>
          </div>
        </div>
        <div class="cont_btn">
      ...
      <div class="form">
        ...
        <div class="cont">
          <div class="cont_inputs">
            ...
            <input type="text" class="input" v-model="Ingrediente_activo" required />
          </div>
          <div class="cont_inputs">
            <label for="Dosis">Dosis</label>
            <input type="text" class="input" v-model="Dosis" required />
          </div>
          <div class="cont_inputs">
            <label for="Metodo_aplicacion">Método de Aplicación</label>
            <input type="text" class="input" v-model="Metodo_aplicacion" required />
          </div>
        </div>
        <div class="cont_btn">
    ...
    <div class="cont_btn_volver">
      <q-btn
        color="primary"
        label="Volver"
        @click="router.push('/preparacionSuelos')"
      ></q-btn>
    </div>
...
let parcela = ref([]);
let preparacionSuelosStore = usePreparacionSuelosStore();
let parcelaStore = useParcelasStore();
...
if (id.value) {
  ...
  titulo.value = "Crear preparación de suelo";
  produc.value = "Agregar";
}
...
function validarCampos() {
  ...
  if (!Estado_Suelo.value.trim()) {
    text.value = "El campo estado suelo es obligatorio";
    registroFallido.value = true;
    ocultar();
    return false;
  }
...
onMounted(async () => {
  spinner.value = true;
  parcela.value = await parcelaStore.getParcelas();
  if(id.value) {
    let preparacionSuelo = await preparacionSuelosStore.getPreparacionSuelo(id.value);
    fecha.value = preparacionSuelo.Fecha.split("T")[0];
    parcelas.value = parcela.value.find((parcela) => parcela._id == preparacionSuelo.Id_parcela);
    responsable.value = preparacionSuelo.Responsable;
    Estado_Suelo.value = preparacionSuelo.Estado_suelo;
    Observaciones.value = preparacionSuelo.Observaciones;
    prodcutos.value = preparacionSuelo.Productos;
