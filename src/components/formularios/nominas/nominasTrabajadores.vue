        ...
        <div class="cont">
          <div class="part1">
            ...
            <div class="cont_inputs">
              ...
              <input type="text" class="input" v-model="tipo_identificacion" />
            </div>
            <div class="cont_inputs">
              <label for="numero_identificacion">Número de Identificación</label>
              <input type="text" class="input" v-model="numero_identificacion" />
            </div>
          </div>
          <div class="part2">
            <div class="cont_inputs">
            ...
            <div class="cont_inputs">
              <label for="informacion_bancaria">Información Bancaria</label>
              <input type="text" class="input" v-model="informacion_bancaria" />
            </div>
          </div>
        </div>
        <div class="cont_btn">
...
let nombre = ref("");
let apellido = ref("");
let tipo_identificacion = ref("");
let numero_identificacion = ref("");
let telefono = ref("");
let direccion = ref("");
let metodo_pago = ref("");
let informacion_bancaria = ref("");

if (id.value) {
  titulo.value = "Editar trabajador";
} else {
  titulo.value = "Crear trabajador";
}

function validarCampos() {
  if (!nombre.value.trim()) {
    registroFallido.value = true;
    text.value = "El nombre no puede estar vacío";
    ocultar();
    return false;
  }
  if (!apellido.value.trim()) {
    registroFallido.value = true;
    text.value = "El apellido no puede estar vacío";
    ocultar();
    return false;
  }
  if (!tipo_identificacion.value.trim()) {
    registroFallido.value = true;
    text.value = "El tipo de identificación no puede estar vacío";
    ocultar();
    return false;
  }
  if (!numero_identificacion.value.trim()) {
    registroFallido.value = true;
    text.value = "El número de identificación no puede estar vacío";
    ocultar();
    return false;
  }
  if (!telefono.value.trim()) {
    registroFallido.value = true;
    text.value = "El teléfono no puede estar vacío";
    ocultar();
    return false;
  }
  if (!direccion.value.trim()) {
    registroFallido.value = true;
    text.value = "La dirección no puede estar vacía";
    ocultar();
    return false;
  }
  ...
  if (!informacion_bancaria.value.trim()) {
    registroFallido.value = true;
    text.value = "La información bancaria no puede estar vacía";
    ocultar();
    return false;
  }
  return true;
...
let enviar = async () => {
  ...
  if (id.value) {
    ...
    let nominasTrabajadores = {
      ...
      Informacion_bancaria: informacion_bancaria.value,
      Historial_modificacion: [modifica],
    }

    console.log(nominasTrabajadores);
    await nominasTrabajadoresStore.putNominaTrabajador(id.value, nominasTrabajadores);
    spinner.value = false;
    registroExitoso.value = true;
    text.value = "Trabajador editado correctamente";
    ocultar();
  } else {
    console.log("Crear");
    spinner.value = true;
    ...
    console.log(nominasTrabajadores);
    await nominasTrabajadoresStore.postNominaTrabajador(nominasTrabajadores);
    spinner.value = false;
    registroExitoso.value = true;
    text.value = "Trabajador creado correctamente";
    ocultar();
  }
}
...
onMounted(async() => {
  spinner.value = true;
  if (id.value) {
    let trabajador = await nominasTrabajadoresStore.getNominaTrabajador(id.value);
    nombre.value = trabajador.Nombre;
    apellido.value = trabajador.Apellido;
    tipo_identificacion.value = trabajador.Tipo_identificacion;
    numero_identificacion.value = trabajador.Numero_identificacion;
    telefono.value = trabajador.Telefono;
    direccion.value = trabajador.Direccion;
    metodo_pago.value = trabajador.Metodo_pago;
    informacion_bancaria.value = trabajador.Informacion_bancaria;
  }
  spinner.value = false;
})
</script>
