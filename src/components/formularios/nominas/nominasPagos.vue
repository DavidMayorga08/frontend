        ...
        <div class="cont">
          <div class="part1">
            <div class="cont_inputs">
              ...
              <select class="input" v-model="trabajador">
                <option
            ...
            <div class="cont_inputs">
              ...
              <input type="Date" class="input" v-model="fecha_pago" />
            </div>
            <div class="cont_inputs">
              <label for="monto_base">Monto base</label>
              <input type="Number" class="input" v-model="monto_base" />
            </div>
            <div class="cont_inputs">
              <label for="bonificaciones">Bonificaciones</label>
              <input type="Number" class="input" v-model="bonificaciones" />
            </div>
            <div class="cont_inputs">
              <label for="motivo_bonificaciones"
                >Motivo de bonificaciones</label
              >
              <input
                type="text"
                class="input"
                v-model="motivo_bonificaciones"
              />
            </div>
          </div>
          <div class="part2">
            <div class="cont_inputs">
              ...
              <input type="Number" class="input" v-model="descuentos" />
            </div>
            <div class="cont_inputs">
              <label for="motivo_descuentos">Motivo de descuentos</label>
              <input type="text" class="input" v-model="motivo_descuentos" />
            </div>
            <div class="cont_inputs">
              <label for="impuestos">Impuestos</label>
              <input type="Number" class="input" v-model="impuestos" />
            </div>
            <div class="cont_inputs">
              <label for="motivo_impuestos">Motivo de impuestos</label>
              <input type="text" class="input" v-model="motivo_impuestos" />
            </div>
            <div class="cont_inputs">
...
let nominasPagosStore = useNominasPagosStore();
let nominasTrabajadoresStore = useNominasTrabajadoresStore();
...
let trabajadores = ref([]);

let titulo = ref("");
let trabajador = ref("");
let fecha_pago = ref("");
let monto_base = ref("");
let bonificaciones = ref("");
let motivo_bonificaciones = ref("");
let descuentos = ref("");
let motivo_descuentos = ref("");
let impuestos = ref("");
let motivo_impuestos = ref("");
let monto_total = ref("");

if (id.value) {
  titulo.value = "Editar Pago";
} else {
  titulo.value = "Crear Pago";
}

function validarCampos() {
  if (trabajador.value === "") {
    registroFallido.value = true;
    text.value = "El campo Trabajador no puede estar vacío";
    ocultar();
    return false;
  }
  if (!fecha_pago.value.trim()) {
    registroFallido.value = true;
    text.value = "El campo Fecha de pago no puede estar vacío";
    ocultar();
    return false;
  }
  if (!String(monto_base.value).trim()) {
    registroFallido.value = true;
    text.value = "El campo Monto base no puede estar vacío";
    ocultar();
    return false;
  }
  if (!String(bonificaciones.value).trim()) {
    registroFallido.value = true;
    text.value = "El campo Bonificaciones no puede estar vacío";
    ocultar();
    return false;
  }
  if (!String(descuentos.value).trim()) {
    registroFallido.value = true;
    text.value = "El campo Descuentos no puede estar vacío";
    ocultar();
    return false;
  }
  if (!String(impuestos.value).trim()) {
    registroFallido.value = true;
    text.value = "El campo Impuestos no puede estar vacío";
    ocultar();
    return false;
  }
  if (!String(monto_total.value).trim()) {
    registroFallido.value = true;
    text.value = "El campo Monto total no puede estar vacío";
    ocultar();
    return false;
  }
  return true;
...
let enviar = async () => {
  ...
  if(id.value) {
    ...
    let nominasPagos = {
      ...
      Id_trabajador: trabajador.value._id,
      Fecha_pago: fecha_pago.value,
      Monto_base: monto_base.value,
      Bonificaciones: bonificaciones.value,
      Motivo_bonificaciones: motivo_bonificaciones.value,
      Descuentos: descuentos.value,
      Motivo_descuentos: motivo_descuentos.value,
      Impuestos: impuestos.value,
      Motivo_impuestos: motivo_impuestos.value,
    ...
    console.log(nominasPagos);
    await nominasPagosStore.putNominaPago(id.value, nominasPagos);
    spinner.value = false;
    registroExitoso.value = true;
    text.value = "Pago editado exitosamente";
    ocultar();
  } else {
    console.log("creando");
    spinner.value = true;
    ...
    console.log(nominasPagos);
    await nominasPagosStore.postNominaPago(nominasPagos);
    spinner.value = false;
    registroExitoso.value = true;
    text.value = "Pago creado exitosamente";
    ocultar();
  }
}
...
onMounted(async () => {
  spinner.value = true;
  trabajadores.value = await nominasTrabajadoresStore.getNominasTrabajadores();  
  if(id.value) {
    let pago = await nominasPagosStore.getNominaPago(id.value);
    trabajador.value = trabajadores.value.find((t) => t._id === pago.Id_trabajador);
    fecha_pago.value = pago.Fecha_pago.split("T")[0];
    monto_base.value = pago.Monto_base;
    bonificaciones.value = pago.Bonificaciones;
    motivo_bonificaciones.value = pago.Motivo_bonificaciones;
    descuentos.value = pago.Descuentos;
    motivo_descuentos.value = pago.Motivo_descuentos;
    impuestos.value = pago.Impuestos;
    motivo_impuestos.value = pago.Motivo_impuestos;
    monto_total.value = pago.Monto_total;
  }
  spinner.value = false;  
});
</script>
