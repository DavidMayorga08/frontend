      ...
      <div class="form">
        ...
        <div class="cont">
          ...
          <div class="cont_inputs">
            ...
            <input type="text" class="input" v-model="categoria" />
          </div>
          <div class="cont_inputs">
            <label for="tarifa_base">Tarifa Base</label>
            <input type="number" class="input" v-model="tarifa_base" />
          </div>
          <div class="cont_inputs">
            <label for="tarifa_producto">Tarifa Producto</label>
            <input type="number" class="input" v-model="tarifa_producto" />
          </div>
          <div class="cont_inputs">
            <label for="unidad_medida">Unidad de Medida</label>
            <input type="text" class="input" v-model="unidad_medida" />
          </div>
        </div>
        <div class="cont_btn">
...
let categoria = ref("");
let tarifa_base = ref("");
let tarifa_producto = ref("");
let unidad_medida = ref("");

if (id.value) {
  titulo.value = "Editar labor";
} else {
  titulo.value = "Crear labor";
}
...
function validarCampos() {
  ...
  if (!categoria.value.trim()) {
    registroFallido.value = true;
    text.value = "El campo Categoria no puede estar vacío";
    ocultar();
    return false;
  }
  if (!tarifa_base.value || tarifa_base.value <= 0) {
    registroFallido.value = true;
    text.value = "El campo Tarifa Base debe ser un número positivo";
    ocultar();
    return false;
  }
  if (!tarifa_producto.value || tarifa_producto.value <= 0) {
    registroFallido.value = true;
    text.value = "El campo Tarifa Producto debe ser un número positivo";
    ocultar();
    return false;
  }
  if (!unidad_medida.value.trim()) {
    registroFallido.value = true;
    text.value = "El campo Unidad de Medida no puede estar vacío";
    ocultar();
    return false;
  }
  return true;
...
let enviar = async () => {
  ...
  if(id.value) {
    ...
    let nominasTiposLabor = {
      Id_finca: id_finca.value,
      Nombre: nombre.value,
      Categoria: categoria.value,
      Tarifa_base: tarifa_base.value,
      Tarifa_producto: tarifa_producto.value,
      Unidad_medida: unidad_medida.value,
      Historial_modificacion: [modifica],
    }

    console.log(nominasTiposLabor);
    await nominasTiposLaborStore.putNominaTipoLabor(id.value, nominasTiposLabor);
    spinner.value = false;
    registroExitoso.value = true;
    text.value = "Labor editada exitosamente";
    ocultar();
  } else {
    console.log("Crear");
    spinner.value = true;
    ...
    let nominasTiposLabor = {
      ...
      Tarifa_producto: tarifa_producto.value,
      Unidad_medida: unidad_medida.value,
      Historial_creacion: [crea],
    }

    console.log(nominasTiposLabor);
    await nominasTiposLaborStore.postNominaTipoLabor(nominasTiposLabor);
    spinner.value = false;
    registroExitoso.value = true;
    text.value = "Labor creada exitosamente";
    ocultar();
  }
}
...
onMounted(async() => {
  spinner.value = true;
  if (id.value) {
    let nominasTiposLabor = await nominasTiposLaborStore.getNominaTipoLabor(id.value);
    nombre.value = nominasTiposLabor.Nombre;
    categoria.value = nominasTiposLabor.Categoria;
    tarifa_base.value = nominasTiposLabor.Tarifa_base;
    tarifa_producto.value = nominasTiposLabor.Tarifa_producto;
    unidad_medida.value = nominasTiposLabor.Unidad_medida;
  }
  spinner.value = false;
})
</script>
