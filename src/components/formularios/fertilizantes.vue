  ...
  <div class="app">
        ...
        <div class="cont">
          <div class="part1">
            ...
            <div class="cont_inputs">
              ...
              <input type="text" class="input" v-model="estado_fenologico" />
            </div>
            <div class="cont_inputs">
              <label for="aplicacion">Aplicacion</label>
              <input type="text" class="input" v-model="aplicacion" />
            </div>
            <div class="cont_inputs">
          ...
          <div class="part2">
            ...
            <div class="cont_inputs">
              ...
              <select class="input" v-model="insumo">
                <option v-for="insumo in insumos" :key="insumo" :value="insumo">
                  {{ insumo.Nombre }}
                </option>
              </select>
            </div>
            <div class="cont_inputs">
              <label for="tipo_fertilizante">Tipo de fertilizantes</label>
              <input type="text" class="input" v-model="tipo_fertilizante" />
            </div>
            <div class="cont_inputs">
    ...
    <div class="cont_btn_volver">
      <q-btn
        color="primary"
        label="Volver"
        @click="router.push('/fertilizantes')"
      ></q-btn>
    </div>
...
let fertilizantesStore = useFertilizanteStore();
...
let responsable = ref("");
let fecha = ref("");
let estado_fenologico = ref("");
let aplicacion = ref("");
let nombre = ref("");
let cantidad = ref("");
let insumo = ref("");
let tipo_fertilizante = ref("");
let observaciones = ref("");

if (id.value) {
  titulo.value = "Editar fertilizante";
} else {
  titulo.value = "Crear fertilizante";
}
...
function validarCampos() {
  ...
  if (!aplicacion.value.trim()) {
    text.value = "El campo aplicacion es obligatorio";
    registroFallido.value = true;
    ocultar();
    return false;
  }
  ...
  if (insumo.value == "") {
    text.value = "El campo insumo es obligatorio";
    registroFallido.value = true;
    ocultar();
    return false;
  }
  if (!tipo_fertilizante.value.trim()) {
    text.value = "El campo tipo de fertilizante es obligatorio";
    registroFallido.value = true;
    ocultar();
    return false;
  }
...
let enviar = async () => {
  ...
  if(id.value){
    ...
    let fertilizante = {
      ...
      Id_insumo: insumo.value._id,
      Tipo_fertilizante: tipo_fertilizante.value,
      Observaciones: observaciones.value,
      Historial_modificacion: [modifica],
    }

    console.log(fertilizante);
    await fertilizantesStore.putFertilizante(id.value, fertilizante);
    spinner.value = false;
    registroExitoso.value = true;
    text.value = "Fertilizante editado correctamente";
    ocultar();
  } else {
    console.log("crear");
    spinner.value = true;
    ...
    console.log(fertilizante);
    await fertilizantesStore.postFertilizante(fertilizante);
    spinner.value = false;
    registroExitoso.value = true;
    text.value = "Fertilizante creado correctamente";
    ocultar();
  }
}
...
onMounted(async () => {
  spinner.value = true;
  insumos.value = await insumosStore.getInsumos();
  if(id.value){
    let fertilizante = await fertilizantesStore.getFertilizante(id.value);
    responsable.value = fertilizante.Responsable;
    fecha.value = fertilizante.Fecha.split("T")[0];
    estado_fenologico.value = fertilizante.Estado_fenologico;
    aplicacion.value = fertilizante.Aplicacion;
    nombre.value = fertilizante.Nombre;
    cantidad.value = fertilizante.Cantidad;
    insumo.value = insumos.value.find((i) => i._id == fertilizante.Id_insumo);
    tipo_fertilizante.value = fertilizante.Tipo_fertilizante;
    observaciones.value = fertilizante.Observaciones;
  }
  spinner.value = false;
});
</script>
