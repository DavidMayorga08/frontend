        ...
        <div class="cont">
          <div class="part1">
            ...
            <div class="cont_inputs">
              ...
              <input type="text" class="input" v-model="tipo_insumo" />
            </div>
            <div class="cont_inputs">
              <label for="fecha_expiracion">Fecha de expiracion</label>
              <input type="Date" class="input" v-model="fecha_expiracion" />
            </div>
            <div class="cont_inputs">
...
let insumosStore = useInsumosStore();
...
if (id.value) {
  titulo.value = "Editar insumo";
} else {
  titulo.value = "Crear insumo";
}
...
function validarCampos() {
  ...
  if (!tipo_insumo.value.trim()) {
    registroFallido.value = true;
    text.value = "El campo Tipo de insumo no puede estar vacío";
    ocultar();
    return false;
  }
  if (!fecha_expiracion.value.trim()) {
    registroFallido.value = true;
    text.value = "El campo Fecha de expiración no puede estar vacío";
    ocultar();
    return false;
  }
  if (proveedor.value === "") {
    registroFallido.value = true;
    text.value = "El campo Proveedor no puede estar vacío";
    ocultar();
    return false;
  }
  if (!registro_ICA.value.trim()) {
    registroFallido.value = true;
    text.value = "El campo Registro ICA no puede estar vacío";
    ocultar();
    return false;
  }
  if (!registro_Invima.value.trim()) {
    registroFallido.value = true;
    text.value = "El campo Registro Invima no puede estar vacío";
    ocultar();
    return false;
  }
  if (!String(cantidad.value).trim()) {
    registroFallido.value = true;
    text.value = "El campo Cantidad no puede estar vacío";
    ocultar();
    return false;
  }
  if (!unidad.value.trim()) {
    registroFallido.value = true;
    text.value = "El campo Unidad no puede estar vacío";
    ocultar();
    return false;
  }
...
let enviar = async () => {
  ...
  if(id.value){
    ...
    console.log(insumo);
    await insumosStore.putInsumo(id.value, insumo);
    spinner.value = false;
    registroExitoso.value = true;
    text.value = "Insumo editado correctamente";
    ocultar();
  } else {
    console.log("Crear");
    spinner.value = true;
    ...
    console.log(insumo);
    await insumosStore.postInsumo(insumo);
    spinner.value = false;
    registroExitoso.value = true;
    text.value = "Insumo creado correctamente";
    ocultar();
  }
}
...
onMounted(async () => {
  ...
  if(id.value) {
    let insumo = await insumosStore.getInsumo(id.value);
    nombre.value = insumo.Nombre;
    tipo_insumo.value = insumo.Tipo_insumo;
    fecha_expiracion.value = insumo.Fecha_expiracion.split("T")[0];
    proveedor.value = proveedores.value.find(proveedor => proveedor._id === insumo.Id_proveedor);
