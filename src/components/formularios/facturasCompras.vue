  ...
  <div class="app">
        ...
        <div class="cont">
          <div class="part1">
            <div class="cont_inputs">
              ...
              <input type="date" class="input" v-model="fechaFactura" />
            </div>
            <div class="cont_inputs">
              <label for="proveedor">Proveedor</label>
              <select class="input" v-model="proveedor">
                <option
                ...
                >
                  {{
                    proveedor.Tipo_proveedor === "Natural"
                      ...
                      : proveedor.Datos_juridica[0].Razon_social
                  }}
                </option>
              </select>
            </div>
            ...
            <div class="cont_inputs">
              ...
              <input type="number" class="input" v-model="impuesto" />
            </div>
            <div class="cont_inputs">
              <label for="totalPagar">Total a pagar</label>
              <input type="number" class="input" v-model="totalPagar" />
            </div>
          </div>
          <div class="part2">
            <div class="cont_inputs">
              <label for="estadoPago">Estado del pago</label>
              <select class="input" v-model="estadoPago">
            ...
            <div class="cont_inputs">
              ...
              <select class="input" v-model="metodoPago">
                <option value="Efectivo">Efectivo</option>
                <option value="Transferencia">Transferencia</option>
              </select>
            </div>
            <div class="cont_inputs" v-if="trnasferencia">
              <label for="detallePago">Detalles del pago</label>
              <button class="btnAbrir" @click="abrirDEtallesPago()">
                {{ detalle }}
              </button>
            </div>
            <div class="cont_inputs">
              <label for="archivo">Adjuntar archivo</label>
              <button class="btnAbrir" @click="abrirArchivo()">
                {{ detalle }}
              </button>
            </div>
          </div>
    ...
    <div class="cont_form2" v-if="form2">
      <div class="form">
        ...
        <div class="cont_titulo">
          <p class="titulo">Detalles de la compra</p>
        </div>
        <div class="cont">
          <div class="cont_inputs">
            <label for="nombreProducto">nombre del producto</label>
            <input type="text" class="input" v-model="nombreProducto" />
          </div>
          <div class="cont_inputs">
            <label for="tipoProducto">Tipo de producto</label>
            <input type="text" class="input" v-model="tipoProducto" />
          </div>
          <div class="cont_inputs">
          ...
          <div class="cont_inputs">
            ...
            <input type="number" class="input" v-model="precioUnitario" />
          </div>
        </div>
        <div class="cont_btn">
          <button class="btn" @click="agregar()">{{ detalle }}</button>
        </div>
      </div>
    </div>
    <div class="cont_form3" v-if="form3">
      <div class="form">
        ...
        <div class="cont_titulo">
          <p class="titulo">Detalles del pago</p>
        </div>
        <div class="cont">
          <div class="cont_inputs">
            <label for="banco">Banco</label>
            <input type="text" class="input" v-model="banco" />
          </div>
          <div class="cont_inputs">
            <label for="numReferencia">Numero de referencia</label>
            <input type="text" class="input" v-model="numReferencia" />
          </div>
          <div class="cont_inputs">
            <label for="fechaPago">Fecha del pago</label>
            <input type="date" class="input" v-model="fechaPago" />
          </div>
        </div>
        <div class="cont_btn">
    ...
    <div class="cont_form4" v-if="form4">
      <div class="form">
        <div class="img_x" @click="cerrarForm()">
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="cont_titulo">
          <p class="titulo">Archivo</p>
        </div>
        <div class="cont">
          <div class="cont_inputs">
            <label for="nombreArchivo">nombre del archivo</label>
            <input type="text" class="input" v-model="nombreArchivo" />
          </div>
          <div class="cont_inputs">
    ...
    <div class="cont_opciones" v-if="opciones">
      <div class="cont_titulo_opciones">
        <p class="titulo">Editar</p>
      </div>
      <div
        v-for="(detalle, index) in DetalleFactura"
        :key="index"
        class="cont_btn"
      >
        <button class="btn" @click="editarProducto(index)">
    ...
    <div class="cont_btn_volver">
      <q-btn
        color="primary"
        label="Volver"
        @click="router.push('/facturasCompras')"
      ></q-btn>
    </div>
...
let facturasComprasStore = useFacturasComprasStore();
...
let titulo = ref("");
let fechaFactura = ref("");
let proveedor = ref("");
let impuesto = ref("");
let DetalleFactura = ref([]);
let total = ref(0);
watch(
  DetalleFactura,
  (newVal) => {
    let subtotal = newVal.reduce((sum, detalle) => sum + detalle.Subtotal, 0);
...
watch(
  ...
  () => {
    let subtotal = DetalleFactura.value.reduce(
      (sum, detalle) => sum + detalle.Subtotal,
      0
    );
    totalPagar.value = subtotal + parseFloat(impuesto.value || 0);
  },
  { deep: true }
);
let estadoPago = ref("");
let metodoPago = ref("");
let trnasferencia = ref(false);
let detalle = ref("");
...
if (id.value) {
  titulo.value = "Editar factura de compra";
  detalle.value = "Editar";
  x = 1;
} else {
  titulo.value = "Agregar factura de compra";
  detalle.value = "Agregar";
  x = 0;
}
...
watch(
  ...
  (value) => {
    if (value === "Transferencia") {
      trnasferencia.value = true;
    } else {
      trnasferencia.value = false;
    }
  }
);

function validarCampos() {
  if (fechaFactura.value.trim() === "") {
  ...
  if (proveedor.value === "") {
    text.value = "El campo proveedor es obligatorio";
    registroFallido.value = true;
    ocultar();
    return false;
  }
  if (DetalleFactura.value.length === 0) {
    text.value = "Debe agregar al menos un producto";
    registroFallido.value = true;
    ocultar();
    return false;
  }
  if (String(impuesto.value).trim() === "") {
    text.value = "El campo impuesto es obligatorio";
    registroFallido.value = true;
    ocultar();
    return false;
  }
  if (String(totalPagar.value).trim() === "") {
    text.value = "El campo total a pagar es obligatorio";
    registroFallido.value = true;
    ocultar();
    return false;
  }
  if (estadoPago.value.trim() === "") {
    text.value = "El campo estado de pago es obligatorio";
    registroFallido.value = true;
    ocultar();
    return false;
  }
  if (metodoPago.value.trim() === "") {
    text.value = "El campo método de pago es obligatorio";
    registroFallido.value = true;
    ocultar();
    return false;
  }
  ...
  if (metodoPago.value === "Transferencia") {
    if (banco.value.trim() === "") {
      text.value = "El campo banco es obligatorio";
      registroFallido.value = true;
      ocultar();
      return false;
    }
    if (numReferencia.value.trim() === "") {
      text.value = "El campo número de referencia es obligatorio";
      registroFallido.value = true;
      ocultar();
      return false;
    }
    if (fechaPago.value.trim() === "") {
      text.value = "El campo fecha de pago es obligatorio";
      registroFallido.value = true;
      ocultar();
      return false;
    }
  ...
  if (nombreArchivo.value.trim() === "") {
    text.value = "El campo nombre del archivo es obligatorio";
    registroFallido.value = true;
    ocultar();
    return false;
  }
  if (url.value.trim() === "") {
    text.value = "El campo URL es obligatorio";
    registroFallido.value = true;
    ocultar();
    return false;
  }
...
let agregar = () => {
  if (
    ...
    !tipoProducto.value.trim() ||
    !String(cantidad.value).trim() ||
    !String(precioUnitario.value).trim()
  ) {
  ...
  if (x.value === 0) {
    const totalProducto = cantidad.value * precioUnitario.value;
    ...
    DetalleFactura.value.push(nuevoDetalle);
    ...
    text.value = "Producto agregado";
    registroExitoso.value = true;
    ocultar();
    console.log(DetalleFactura.value);
  }
  else {
    const totalProducto = cantidad.value * precioUnitario.value;
    ...
    DetalleFactura.value.splice(editando.value, 0, nuevoDetalle);
...
let enviar = async () => {
  ...
  if (id.value) {
    ...
    let compra = {
      ...
      Fecha_factura: fechaFactura.value,
      Id_proveedor: proveedor.value._id,
      Detalle_compra: DetalleFactura.value,
      Total: total.value,
      Impuestos: impuesto.value,
      Total_pagar: totalPagar.value,
    ...
    if (metodoPago.value === "Transferencia") {
      compra.Metodo_pago.Detalles = {
        Banco: banco.value,
        Numero_referencia: numReferencia.value,
    ...
    await facturasComprasStore.postFacturaCompra(compra);
    spinner.value = false;
    registroExitoso.value = true;
    text.value = "Factura agregada exitosamente";
    ocultar();
  }
};
...
let editarProducto = (index) => {
  nombreProducto.value = DetalleFactura.value[index].Nombre_producto;
  tipoProducto.value = DetalleFactura.value[index].Tipo_producto;
  cantidad.value = DetalleFactura.value[index].Cantidad;
  precioUnitario.value = DetalleFactura.value[index].Precio_unitario;
  DetalleFactura.value.splice(index, 1);
...
onMounted(async () => {
  spinner.value = true;
  proveedores.value = await proveedoresStore.getProveedores();
  if (id.value) {
    let compra = await facturasComprasStore.getFacturaCompra(id.value);
    fechaFactura.value = compra.Fecha_factura.split("T")[0];
    proveedor.value = proveedores.value.find(
      (proveedor) => proveedor._id === compra.Id_proveedor
    );
    DetalleFactura.value = compra.Detalle_compra;
    impuesto.value = compra.Impuestos;
    estadoPago.value = compra.Estado_pago;
    metodoPago.value = compra.Metodo_pago.Tipo;
    if (metodoPago.value === "Transferencia") {
      trnasferencia.value = true;
      banco.value = compra.Metodo_pago.Detalles.Banco;
      numReferencia.value = compra.Metodo_pago.Detalles.Numero_referencia;
      fechaPago.value = compra.Metodo_pago.Detalles.Fecha_pago.split("T")[0];
    }
    nombreArchivo.value = compra.Archivo_adjunto.Nombre_archivo;
    url.value = compra.Archivo_adjunto.Url;
    console.log(DetalleFactura.value);
  }
  spinner.value = false;
});
