  ...
  <div class="app">
        ...
        <div class="cont">
          <div class="part1">
            ...
            <div class="cont_inputs">
              ...
              <select class="input" v-model="parcela">
                <option
          ...
          <div class="part2">
            <div class="cont_inputs">
              ...
              <input type="text" class="input" v-model="recomendaciones" />
            </div>
            <div class="cont_inputs">
            ...
            <div class="cont_inputs">
              ...
              <button class="btnAbrir" @click="abrir()">Resultado</button>
            </div>
          </div>
        </div>
        <div class="cont_btn">
        ...
        <div class="cont">
          <div class="part1">
            <div class="cont_inputs">
              ...
              <input type="number" class="input" v-model="fosforo" required />
            </div>
            <div class="cont_inputs">
              <label for="azufre">Azufre</label>
              <input type="number" class="input" v-model="azufre" required />
            </div>
            <div class="cont_inputs">
              <label for="zinc">Zinc</label>
              <input type="number" class="input" v-model="zinc" required />
            </div>
            <div class="cont_inputs">
              <label for="manganeso">Manganeso</label>
              <input type="number" class="input" v-model="manganeso" required />
            </div>
            <div class="cont_inputs">
              <label for="cobre">Cobre</label>
              <input type="number" class="input" v-model="cobre" required />
            </div>
          </div>
          <div class="part2">
            <div class="cont_inputs">
              <label for="potasio">Potasio</label>
              <input type="number" class="input" v-model="potasio" required />
            </div>
            <div class="cont_inputs">
              <label for="calcio">Calcio</label>
              <input type="number" class="input" v-model="calcio" required />
            </div>
            <div class="cont_inputs">
              <label for="magnesio">Magnesio</label>
              <input type="number" class="input" v-model="magnesio" required />
            </div>
            <div class="cont_inputs">
              <label for="sodio">Sodio</label>
              <input type="number" class="input" v-model="sodio" required />
            </div>
          </div>
        </div>
        <div class="cont_btn">
    ...
    <div class="cont_btn_volver">
      <q-btn
        color="primary"
        label="Volver"
        @click="router.push('/analisisSuelos')"
      ></q-btn>
    </div>
...
if (id.value) {
  titulo.value = "Editar analisis de suelo";
} else {
  titulo.value = "Crear analisis de suelo";
}
...
function validarCampos() {
  ...
  if (parcela.value === "") {
    registroFallido.value = true;
    text.value = "El campo Parcela es obligatorio";
    ocultar();
    return false;
  }
  ...
  if (!muestra.value.trim() === "") {
    registroFallido.value = true;
    text.value = "El campo Muestra es obligatorio";
    ocultar();
    return false;
  }
  if (!laboratorio.value.trim() === "") {
    registroFallido.value = true;
    text.value = "El campo Laboratorio es obligatorio";
    ocultar();
    return false;
  }
  if (!recomendaciones.value.trim() === "") {
    registroFallido.value = true;
    text.value = "El campo Recomendaciones es obligatorio";
    ocultar();
    return false;
  }
  ...
  if (!String(fosforo.value).trim() === "") {
    registroFallido.value = true;
    text.value = "El campo Fósforo es obligatorio";
    ocultar();
    return false;
  }
  if (!String(azufre.value).trim() === "") {
    registroFallido.value = true;
    text.value = "El campo Azufre es obligatorio";
    ocultar();
    return false;
  }
  if (!String(zinc.value).trim() === "") {
    registroFallido.value = true;
    text.value = "El campo Zinc es obligatorio";
    ocultar();
    return false;
  }
  if (!String(manganeso.value).trim() === "") {
    registroFallido.value = true;
    text.value = "El campo Manganeso es obligatorio";
    ocultar();
    return false;
  }
  if (!String(cobre.value).trim() === "") {
    registroFallido.value = true;
    text.value = "El campo Cobre es obligatorio";
    ocultar();
    return false;
  }
  if (!String(potasio.value).trim() === "") {
    registroFallido.value = true;
    text.value = "El campo Potasio es obligatorio";
    ocultar();
    return false;
  }
  if (!String(calcio.value).trim() === "") {
    registroFallido.value = true;
    text.value = "El campo Calcio es obligatorio";
    ocultar();
    return false;
  }
  if (!String(magnesio.value).trim() === "") {
    registroFallido.value = true;
    text.value = "El campo Magnesio es obligatorio";
    ocultar();
    return false;
  }
  if (!String(sodio.value).trim() === "") {
    registroFallido.value = true;
    text.value = "El campo Sodio es obligatorio";
    ocultar();
    return false;
  }
  return true;
...
let enviar = async () => {
  ...
  if(id.value){
    ...
    await useAnalisisSuelos.putAnalisisSuelo(id.value, analisisSuelos);
    spinner.value = false;
    registroExitoso.value = true;
    text.value = "Analisis de suelo editado correctamente";
    ocultar();
  } else {
    console.log("Crear");
    spinner.value = true;
    ...
    console.log(analisisSuelos);
    await useAnalisisSuelos.postAnalisisSuelo(analisisSuelos);
    spinner.value = false;
    registroExitoso.value = true;
    text.value = "Analisis de suelo creado correctamente";
    ocultar();
  }
}
...
onMounted(async () => {
  ...
  if(id.value) {
    let analisisSuelo = await useAnalisisSuelos.getAnalisisSuelo(id.value);
    fecha.value = analisisSuelo.Fecha.split("T")[0];
    parcela.value = parcelas.value.find((parcela) => parcela._id === analisisSuelo.Id_parcela);
    responsable.value = analisisSuelo.Responsable;
    muestra.value = analisisSuelo.Muestra;
    laboratorio.value = analisisSuelo.Laboratorio;
    recomendaciones.value = analisisSuelo.Recomendaciones;
    estado.value = analisisSuelo.Estado;
    fosforo.value = analisisSuelo.Resultado[0].Fosforo;
    azufre.value = analisisSuelo.Resultado[0].Azufre;
    zinc.value = analisisSuelo.Resultado[0].Zinc;
    manganeso.value = analisisSuelo.Resultado[0].Manganeso;
    cobre.value = analisisSuelo.Resultado[0].Cobre;
    potasio.value = analisisSuelo.Resultado[0].Potasio;
    calcio.value = analisisSuelo.Resultado[0].Calcio;
    magnesio.value = analisisSuelo.Resultado[0].Magnesio;
    sodio.value = analisisSuelo.Resultado[0].Sodio;
  }
  spinner.value = false;
});
</script>
