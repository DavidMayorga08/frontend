        ...
        <div class="cont">
          <div class="part1">
            ...
            <div class="cont_inputs">
              ...
              <input type="text" class="input" v-model="registro_ICA" />
            </div>
            <div class="cont_inputs">
              <label for="registro_Invima">Registro Invima</label>
              <input type="text" class="input" v-model="registro_Invima" />
            </div>
            <div class="cont_inputs">
              <label for="fecha_vencimiento">Fecha de vencimiento</label>
              <input type="Date" class="input" v-model="fecha_vencimiento" />
            </div>
            <div class="cont_inputs">
              <label for="especie_variedad">Variedad</label>
              <input type="text" class="input" v-model="especie_variedad" />
            </div>
            <div class="cont_inputs">
              <label for="NroLote">Numero de lote</label>
              <input type="text" class="input" v-model="NroLote" />
            </div>
          </div>
          <div class="part2">
            <div class="cont_inputs">
            ...
            <div class="cont_inputs">
              ...
              <input type="text" class="input" v-model="cantidad" />
            </div>
            <div class="cont_inputs">
              <label for="condiciones_almacenamiento"
                >Condiciones de almacenamiento</label
              >
              <input
                type="text"
                class="input"
                v-model="condiciones_almacenamiento"
              />
            </div>
            <div class="cont_inputs">
              <label for="metodo_almacenamiento"
                >Metodo de almacenamiento</label
              >
              <input
                type="text"
                class="input"
                v-model="metodo_almacenamiento"
              />
            </div>
          </div>
        </div>
...
let especie_variedad = ref("");
let NroLote = ref("");
let origen = ref("");
let poder_germinativo = ref("");
let observaciones = ref("");
let cantidad = ref("");
let condiciones_almacenamiento = ref("");
let metodo_almacenamiento = ref("");

if (id.value) {
  titulo.value = "Editar semilla";
} else {
  titulo.value = "Crear semilla";
}
...
function validarCampos() {
  ...
  if (!registro_ICA.value.trim()) {
    text.value = "El campo registro ICA es obligatorio";
    registroFallido.value = true;
    ocultar();
    return false;
  }
  if (!registro_Invima.value.trim()) {
    text.value = "El campo registro Invima es obligatorio";
    registroFallido.value = true;
    ocultar();
    return false;
  }
  if (!fecha_vencimiento.value.trim()) {
    text.value = "El campo fecha de vencimiento es obligatorio";
    registroFallido.value = true;
    ocultar();
    return false;
  }
  if (!especie_variedad.value.trim()) {
    text.value = "El campo especie o variedad es obligatorio";
    registroFallido.value = true;
    ocultar();
    return false;
  }
  if (!String(NroLote.value).trim()) {
    text.value = "El campo numero de lote es obligatorio";
    registroFallido.value = true;
    ocultar();
    return false;
  }
  if (!origen.value.trim()) {
    text.value = "El campo origen es obligatorio";
    registroFallido.value = true;
    ocultar();
    return false;
  }
  if (!String(poder_germinativo.value).trim()) {
    text.value = "El campo poder germinativo es obligatorio";
    registroFallido.value = true;
    ocultar();
    return false;
  }
  ...
  if (!condiciones_almacenamiento.value.trim()) {
    text.value = "El campo condiciones de almacenamiento es obligatorio";
    registroFallido.value = true;
    ocultar();
    return false;
  }
  if (!metodo_almacenamiento.value.trim()) {
    text.value = "El campo metodo de almacenamiento es obligatorio";
    registroFallido.value = true;
    ocultar();
    return false;
  }
...
let enviar = async () => {
  ...
  if(id.value){
    ...
    let semilla = {
      ...
      Especie_variedad: especie_variedad.value,
      NroLote: NroLote.value,
      Origen: origen.value,
      Poder_germinativo: poder_germinativo.value,
      Observaciones: observaciones.value,
      Cantidad: cantidad.value,
      Condiciones_almacenamiento: condiciones_almacenamiento.value,
      Metodo_almacenamiento: metodo_almacenamiento.value,
      Historial_modificacion: [modifica],
    }
    console.log(semilla);
    await useSemillas.putSemilla(id.value, semilla);
    spinner.value = false;
    registroExitoso.value = true;
    text.value = "Semilla editada correctamente";
    ocultar();
  } else {
    console.log("crear");
    spinner.value = true;
    ...
    console.log(semilla);
    await useSemillas.postSemilla(semilla);
    spinner.value = false;
    registroExitoso.value = true;
    text.value = "Semilla creada correctamente";
    ocultar();
  }
}
...
onMounted(async () => {
  spinner.value = true;
  if(id.value) {
    let semilla = await useSemillas.getSemilla(id.value);
    nombre.value = semilla.Nombre;
    registro_ICA.value = semilla.Registro_ICA;
    registro_Invima.value = semilla.Registro_Invima;
    fecha_vencimiento.value = semilla.Fecha_vencimiento.split("T")[0];
    especie_variedad.value = semilla.Especie_variedad;
    NroLote.value = semilla.NroLote;
    origen.value = semilla.Origen;
    poder_germinativo.value = semilla.Poder_germinativo;
    observaciones.value = semilla.Observaciones;
    cantidad.value = semilla.Cantidad;
    condiciones_almacenamiento.value = semilla.Condiciones_almacenamiento;
    metodo_almacenamiento.value = semilla.Metodo_almacenamiento;
  }
  spinner.value = false;
})
</script>
