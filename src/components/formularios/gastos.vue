        ...
        <div class="cont">
          <div class="part1">
            ...
            <div class="cont_inputs">
              ...
              <input type="text" class="input" v-model="monto" />
            </div>
            <div class="cont_inputs">
          ...
          <div class="part2">
            ...
            <div class="cont_inputs">
              ...
              <select class="input" v-model="metodo_pago">
...
let gastosStore = useGastosStore();
...
if (id.value) {
  titulo.value = "Editar gasto";
} else {
  titulo.value = "Crear gasto";
}
...
function validarCampos() {
  ...
  if(!String(monto.value).trim() === "") {
    registroFallido.value = true;
    text.value = "El campo monto es obligatorio";
    ocultar();
    return false;
  }
  ...
  if(!metodo_pago.value.trim() === "") {
    registroFallido.value = true;
    text.value = "El campo metodo de pago es obligatorio";
    ocultar();
    return false;
  }
  return true;
...
let enviar = async () => {
  ...
  if(id.value) {
    ...
    console.log(gasto);
    await gastosStore.putGasto(id.value, gasto);
    spinner.value = false;
    registroExitoso.value = true;
    text.value = "Gasto modificado exitosamente";
    ocultar();
  } else {
    console.log("Crear");
    spinner.value = true;
    ...
    console.log(gasto);
    await gastosStore.postGasto(gasto);
    spinner.value = false;
    registroExitoso.value = true;
    text.value = "Gasto creado exitosamente";
    ocultar();
  }
}
...
onMounted(async () => {
  spinner.value = true;
  if(id.value) {
    let gasto = await gastosStore.getGasto(id.value);
    fecha.value = gasto.Fecha.split("T")[0];
    monto.value = gasto.Monto;
    descripcion.value = gasto.Descripcion;
    responsable.value = gasto.Responsable;
    metodo_pago.value = gasto.Metodo_pago;
    console.log(gasto);
  }
  spinner.value = false;
});
