        ...
        <div class="cont">
          <div class="part1">
            <div class="cont_inputs">
              ...
              <input type="number" class="input" v-model="numero" />
            </div>
            <div class="cont_inputs">
              <label for="cultivo_anterior">Cultivo anterior</label>
              <input type="text" class="input" v-model="cultivo_anterior" />
            </div>
            <div class="cont_inputs">
              <label for="cultivo_actual">Cultivo actual</label>
              <input type="text" class="input" v-model="cultivo_actual" />
            </div>
          </div>
          <div class="part2">
            <div class="cont_inputs">
              <label for="detalles_suelo">Detalles del suelo</label>
              <input type="text" class="input" v-model="detalles_suelo" />
            </div>
            <div class="cont_inputs">
              <label for="obsercaciones">Observaciones</label>
              <input type="text" class="input" v-model="obsercaciones" />
            </div>
            <div class="cont_inputs">
...
let titulo = ref("");
let numero = ref("");
let cultivo_anterior = ref("");
let cultivo_actual = ref("");
let detalles_suelo = ref("");
let obsercaciones = ref("");
let estado = ref("");

if (id.value) {
  titulo.value = "Editar parcela";
} else {
  titulo.value = "Crear parcela";
}

function validarCampos() {
  if (!String(numero.value).trim()) {
    mostrarError("El campo 'Numero' no puede estar vacío");
    return false;
  }
  if (!cultivo_anterior.value.trim()) {
    mostrarError("El campo 'Cultivo anterior' no puede estar vacío");
    return false;
  }
  if (!cultivo_actual.value.trim()) {
    mostrarError("El campo 'Cultivo actual' no puede estar vacío");
    return false;
  }
  if (!detalles_suelo.value.trim()) {
    mostrarError("El campo 'Detalles del suelo' no puede estar vacío");
    return false;
  }
  if (!obsercaciones.value.trim()) {
    mostrarError("El campo 'Observaciones' no puede estar vacío");
    return false;
  }
...
let enviar = async () => {
  ...
  if(id.value){
    ...
    let parcela = {
      ...
      Numero: numero.value,
      Cultivo_anterior: cultivo_anterior.value,
      Cultivo_actual: cultivo_actual.value,
      Detalles_suelo: detalles_suelo.value,
      Observaciones: obsercaciones.value,
      Estado: estado.value,
      Historial_modificacion: [modifica],
    }
    console.log(parcela);
    await parcelasStore.putParcela(id.value, parcela);
    spinner.value = false;
    text.value = "Parcela editada correctamente";
    ...
    console.log(parcela);
    await parcelasStore.postParcela(parcela);
    spinner.value = false;
    text.value = "Parcela creada correctamente";
    registroExitoso.value = true;
    ocultar();
  }
}
...
onMounted(async () => {
  spinner.value = true;
  if (id.value) {
    let parcela = await parcelasStore.getParcela(id.value);
    numero.value = parcela.Numero;
    cultivo_anterior.value = parcela.Cultivo_anterior;
    cultivo_actual.value = parcela.Cultivo_actual;
    detalles_suelo.value = parcela.Detalles_suelo;
    obsercaciones.value = parcela.Observaciones;
    estado.value = parcela.Estado;
  }
  spinner.value = false;
})
</script>
