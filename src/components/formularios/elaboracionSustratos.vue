  ...
  <div class="app">
        ...
        <div class="cont">
          <div class="part1">
            <div class="cont_inputs">
              ...
              <select class="input" v-model="cultivo">
                <option
            ...
            <div class="cont_inputs">
              <label for="producto_comercial">Producto comercial</label>
              <input type="text" class="input" v-model="producto_comercial" />
            </div>
            <div class="cont_inputs">
              <label for="ingrediente_activo">Ingrediente activo</label>
              <input type="text" class="input" v-model="ingrediente_activo" />
            </div>
            <div class="cont_inputs">
          ...
          <div class="part2">
            <div class="cont_inputs">
              <label for="metodo_aplicacion">Metodo de aplicacion</label>
              <input type="text" class="input" v-model="metodo_aplicacion" />
            </div>
            <div class="cont_inputs">
              <label for="cantidad_producida">Cantidad producida</label>
              <input type="Number" class="input" v-model="cantidad_producida" />
            </div>
            <div class="cont_inputs">
    ...
    <div class="cont_btn_volver">
      <q-btn
        color="primary"
        label="Volver"
        @click="router.push('/elaboracion-sustratos')"
      ></q-btn>
    </div>
...
import { useElaboracionSustratosStore } from "../../stores/elaboracionSustratos.js";
import { useCultivosStore } from "../../stores/cultivos.js";

let elaboracionSustratosStore = useElaboracionSustratosStore();
let cultivosStore = useCultivosStore();
...
let cultivo = ref("");
let fecha = ref("");
let producto_comercial = ref("");
let ingrediente_activo = ref("");
let dosis = ref("");
let metodo_aplicacion = ref("");
let cantidad_producida = ref("");
let responsable = ref("");
let observaciones = ref("");

if (id.value) {
  titulo.value = "Editar elaboración de sustrato";
} else {
  titulo.value = "Crear elaboración de sustrato";
}

function validarCampos() {
  if (cultivo.value === "") {
    registroFallido.value = true;
    text.value = "El campo Cultivo no puede estar vacío";
    ocultar();
    return false;
  }
  if (!fecha.value.trim()) {
  ...
  if (!producto_comercial.value.trim()) {
    registroFallido.value = true;
    text.value = "El campo Producto comercial no puede estar vacío";
    ocultar();
    return false;
  }
  if (!ingrediente_activo.value.trim()) {
    registroFallido.value = true;
    text.value = "El campo Ingrediente activo no puede estar vacío";
    return false;
  }
  if (!String(dosis.value).trim()) {
    registroFallido.value = true;
    text.value = "El campo Dosis aplicada no puede estar vacío";
    ocultar();
    return false;
  }
  if (!metodo_aplicacion.value.trim()) {
    registroFallido.value = true;
    text.value = "El campo Método de aplicación no puede estar vacío";
    ocultar();
    return false;
  }
  if (!String(cantidad_producida.value).trim()) {
    registroFallido.value = true;
    text.value = "El campo Cantidad producida no puede estar vacío";
    ocultar();
    return false;
  }
  if (!responsable.value.trim()) {
    registroFallido.value = true;
    text.value = "El campo Responsable no puede estar vacío";
    ocultar();
    return false;
  }
  if (!observaciones.value.trim()) {
    registroFallido.value = true;
    text.value = "El campo Observaciones no puede estar vacío";
    ocultar();
    return false;
  }
  return true;
...
let enviar = async () => {
  ...
  if(id.value) {
    ...
    let elaboracionSustrato = {
      ...
      Fecha: fecha.value,
      Producto_comercial: producto_comercial.value,
      Ingrediente_activo: ingrediente_activo.value,
      Dosis: dosis.value,
      Metodo_aplicacion: metodo_aplicacion.value,
      Cantidad_producida: cantidad_producida.value,
      Responsable: responsable.value,
      Observaciones: observaciones.value,
      Historial_modificacion: [modifica],
    }

    console.log(elaboracionSustrato);
    await elaboracionSustratosStore.putElaboracionSustrato(id.value, elaboracionSustrato);
    spinner.value = false;
    registroExitoso.value = true;
    text.value = "Elaboración de sustrato editada exitosamente";
    ocultar();
  } else {
    console.log("Crear");
    spinner.value = true;
    ...
    console.log(elaboracionSustrato);
    await elaboracionSustratosStore.postElaboracionSustrato(elaboracionSustrato);
    spinner.value = false;
    registroExitoso.value = true;
    text.value = "Elaboración de sustrato creada exitosamente";
    ocultar();
  }
}
...
onMounted(async () => {
  ...
  if(id.value) {
    let elaboracionSustrato = await elaboracionSustratosStore.getElaboracionSustrato(id.value);
    cultivo.value = cultivos.value.find((cultivo) => cultivo._id === elaboracionSustrato.Id_cultivo);
    fecha.value = elaboracionSustrato.Fecha.split("T")[0];
    producto_comercial.value = elaboracionSustrato.Producto_comercial;
    ingrediente_activo.value = elaboracionSustrato.Ingrediente_activo;
    dosis.value = elaboracionSustrato.Dosis;
    metodo_aplicacion.value = elaboracionSustrato.Metodo_aplicacion;
    cantidad_producida.value = elaboracionSustrato.Cantidad_producida;
    responsable.value = elaboracionSustrato.Responsable;
    observaciones.value = elaboracionSustrato.Observaciones;
  }
  spinner.value = false;
});
</script>
