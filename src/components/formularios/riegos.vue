      ...
      <div class="form">
        ...
        <div class="cont">
          <div class="part1">
            ...
            <div class="cont_inputs">
              <label for="dias_transplante">Dias del transplante</label>
              <input type="Number" class="input" v-model="dias_transplante" />
            </div>
            <div class="cont_inputs">
          ...
          <div class="part2">
            ...
            <div class="cont_inputs">
              ...
              <input type="text" class="input" v-model="metodo_riego" />
            </div>
            <div class="cont_inputs">
...
let riegosStore = useRiegosStore();
...
let responsable = ref("");
let fecha = ref("");
let dias_transplante = ref("");
let estado_fenologico = ref("");
let hora_inicio = ref("");
let hora_fin = ref("");
let dosis = ref("");
let cantidad_agua = ref("");
let metodo_riego = ref("");
let observaciones = ref("");

if (id.value) {
  titulo.value = "Editar riego";
} else {
  titulo.value = "Crear riego";
}
...
let enviar = async () => {
  ...
  if (id.value) {
    ...
    text.value = "Riego editado correctamente";
    ocultar();
  } else {
    console.log("crear");
    spinner.value = true;
...
onMounted(async () => {
  ...
  if (id.value) {
    ...
    metodo_riego.value = riego.Metodo_riego;
