  ...
  <div class="app">
        ...
        <div class="cont">
          <div class="part1">
            ...
            <div class="cont_inputs">
              ...
              <input type="text" class="input" v-model="especie" />
            </div>
            <div class="cont_inputs">
          ...
          <div class="part2">
            <div class="cont_inputs">
              <label for="cantidad_trabajadores"
                >Cantidad de trabajadores</label
              >
              <input
                type="text"
                class="input"
                v-model="cantidad_trabajadores"
              />
            </div>
            <div class="cont_inputs">
            ...
            <div class="cont_inputs">
              <label for="estado_produccion">Estado de Producción</label>
              <select class="input" v-model="estado_produccion">
            ...
            <div class="cont_inputs">
              <label for="calidad_produccion">Calidad de Producción</label>
              <select class="input" v-model="calidad_produccion">
            ...
            <div class="cont_inputs">
              ...
              <input type="text" class="input" v-model="unidad" />
            </div>
          </div>
        </div>
        <div class="cont_btn">
    ...
    <div class="cont_btn_volver">
      <q-btn
        color="primary"
        label="Volver"
        @click="router.push('/producciones')"
      ></q-btn>
    </div>
...
let produccionesStore = useProduccionesStore();
...
let especie = ref("");
let cantidad = ref("");
let cantidad_trabajadores = ref("");
let observaciones = ref("");
let estado_produccion = ref("");
let calidad_produccion = ref("");
let unidad = ref("");

if (id.value) {
  titulo.value = "Editar produccion";
} else {
  titulo.value = "Crear produccion";
}
...
function validarCampos() {
  ...
  if (!String(NroLote.value).trim()) {
    text.value = "El campo NroLote es obligatorio";
    registroFallido.value = true;
    ocultar();
    return false;
  }
  if (!especie.value.trim()) {
    text.value = "El campo especie es obligatorio";
    registroFallido.value = true;
    ocultar();
    return false;
  }
  ...
  if (!String(cantidad_trabajadores.value).trim()) {
    text.value = "El campo cantidad_trabajadores es obligatorio";
    registroFallido.value = true;
    ocultar();
    return false;
  }
  ...
  if (!estado_produccion.value.trim()) {
    text.value = "El campo estado_produccion es obligatorio";
    registroFallido.value = true;
    ocultar();
    return false;
  }
  if (!calidad_produccion.value.trim()) {
    text.value = "El campo calidad_produccion es obligatorio";
    registroFallido.value = true;
    ocultar();
    return false;
  }
  if (!unidad.value.trim()) {
    text.value = "El campo unidad es obligatorio";
    registroFallido.value = true;
    ocultar();
    return false;
  }
...
let enviar = async () => {
  ...
  if(id.value) {
    ...
    let produccion = {
      ...
      Unidad: unidad.value,
      Cantidad_trabajadores: cantidad_trabajadores.value,
      Observaciones: observaciones.value,
      Estado_produccion: estado_produccion.value,
      Calidad_produccion: calidad_produccion.value,
      Historial_modificacion: [modifica],
    }
    console.log(produccion);
    await produccionesStore.putProduccion(id.value, produccion);
    spinner.value = false;
    registroExitoso.value = true;
    text.value = "Produccion editada exitosamente";
    ocultar();
  } else {
    console.log("crear");
    spinner.value = true;
    ...
    console.log(produccion);
    await produccionesStore.postProduccion(produccion);
    spinner.value = false;
    registroExitoso.value = true;
    text.value = "Produccion creada exitosamente";
    ocultar();
  }
}
...
onMounted(async () => {
  ...
  if(id.value) {
    let produccion = await produccionesStore.getProduccion(id.value);
    cultivo.value = cultivos.value.find((c) => c._id == produccion.Id_cultivo);
    fecha.value = produccion.Fecha.split("T")[0];
    NroLote.value = produccion.NroLote;
    especie.value = produccion.Especie;
    cantidad.value = produccion.Cantidad;
    unidad.value = produccion.Unidad;
    cantidad_trabajadores.value = produccion.Cantidad_trabajadores;
    observaciones.value = produccion.Observaciones;
    estado_produccion.value = produccion.Estado_produccion;
    calidad_produccion.value = produccion.Calidad_produccion;
  }
  spinner.value = false;
});
</script>
