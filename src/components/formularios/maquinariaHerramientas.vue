  ...
  <div class="app">
        ...
        <div class="cont">
          <div class="part1">
            <div class="cont_inputs">
              ...
              <select class="input" v-model="proveedor">
                <option
                  ...
                  :value="proveedor"
                >
                {{ proveedor.Tipo_proveedor === 'Natural' ? proveedor.Datos_natural[0].Nombre : proveedor.Datos_juridica[0].Razon_social }}
                </option>
              </select>
            </div>
            <div class="cont_inputs">
            ...
            <div class="cont_inputs">
              ...
              <select class="input" v-model="Tipo">
            ...
            <div class="cont_inputs">
              ...
              <input type="date" class="input" v-model="Fecha_compra" />
            </div>
          </div>
          <div class="part2">
            <div class="cont_inputs">
            ...
            <div class="cont_inputs">
              ...
              <input type="text" class="input" v-model="Total" />
            </div>
          </div>
        </div>
        <div class="cont_btn">
    ...
    <div class="cont_btn_volver">
      <q-btn
        color="primary"
        label="Volver"
        @click="router.push('/maquinariaHerramientas')"
      ></q-btn>
    </div>
...
let maquinariaHerramientasStore = useMaquinariaHerramientasStore();
...
let nombre = ref("");
let Tipo = ref("");
let Fecha_compra = ref("");
let Observaciones = ref("");
let Cantidad = ref("");
let Total = ref("");

if (id.value) {
  titulo.value = "Editar maquinaria o herramienta";
} else {
  titulo.value = "Crear maquinaria o herramienta";
}
...
function validarCampos() {
  ...
  if (Tipo.value === "") {
    text.value = "El campo tipo es obligatorio";
    registroFallido.value = true;
    ocultar();
    return false;
  }
  if (!Fecha_compra.value.trim()) {
    text.value = "El campo fecha compra es obligatorio";
    registroFallido.value = true;
    ocultar();
    return false;
  }
  ...
  if (!String(Total.value).trim()) {
    text.value = "El campo total es obligatorio";
    registroFallido.value = true;
    ocultar();
    return false;
  }
...
let enviar = async () => {
  ...
  if(id.value){
    ...
    console.log(maquinariaHerramienta);
    await maquinariaHerramientasStore.putMaquinariaHerramienta(id.value, maquinariaHerramienta);
    spinner.value = false;
    text.value = "Maquinaria o herramienta editada correctamente";
    ...
    console.log(maquinariaHerramienta);
    await maquinariaHerramientasStore.postMaquinariaHerramienta(maquinariaHerramienta);
    spinner.value = false;
    text.value = "Maquinaria o herramienta creada correctamente";
    registroExitoso.value = true;
    ocultar();
  }
}
...
onMounted(async () => {
  ...
  if(id.value){
    let maquinariaHerramienta = await maquinariaHerramientasStore.getMaquinariaHerramienta(id.value);
    console.log(maquinariaHerramienta);
    proveedor.value = proveedores.value.find(proveedor => proveedor._id === maquinariaHerramienta.Id_proveedor);
    nombre.value = maquinariaHerramienta.Nombre;
    Tipo.value = maquinariaHerramienta.Tipo;
    Fecha_compra.value = maquinariaHerramienta.Fecha_compra.split("T")[0];
    Observaciones.value = maquinariaHerramienta.Observaciones;
    Cantidad.value = maquinariaHerramienta.Cantidad;
    Total.value = maquinariaHerramienta.Total;
    mantenimiento.value = maquinariaHerramienta.Mantenimiento;
    desinfeccion.value = maquinariaHerramienta.Desinfeccion;
  }
  spinner.value = false;
});
</script>
