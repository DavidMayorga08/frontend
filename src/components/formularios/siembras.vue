        ...
        <div class="cont">
          <div class="part1">
            ...
            <div class="cont_inputs">
              ...
              <input type="Date" class="input" v-model="fecha_cosecha" />
            </div>
          </div>
          <div class="part2">
            <div class="cont_inputs">
            ...
            <div class="cont_inputs">
              ...
              <select class="input" v-model="semilla">
                <option
                  v-for="semilla in semillas"
                  :key="semilla"
                  :value="semilla"
                >
                  {{ semilla.Nombre }}
...
let siembrasStore = useSiembrasStore();
let cultivosStore = useCultivosStore();
let semillasStore = useSemillasStore();
...
if (id.value) {
  titulo.value = "Editar siembra";
} else {
  titulo.value = "Crear siembra";
}
...
function validarCampos() {
  ...
  if (!fecha_siembra.value.trim()) {
    text.value = "El campo fecha de siembra es obligatorio";
    registroFallido.value = true;
    ocultar();
    return false;
  }
  if (!fecha_cosecha.value.trim()) {
    text.value = "El campo fecha de cosecha es obligatorio";
    registroFallido.value = true;
    ocultar();
    return false;
  }
  ...
  if (semilla.value === "") {
    text.value = "El campo semilla es obligatorio";
    registroFallido.value = true;
    ocultar();
    return false;
  }
...
let enviar = async () => {
  ...
  if (id.value) {
    ...
    console.log(siembra);
    await siembrasStore.putSiembra(id.value, siembra);
    spinner.value = false;
    text.value = "Siembra editada correctamente";
...
onMounted(async () => {
  ...
  semillas.value = await semillasStore.getSemillas();
  if (id.value) {
    let siembra = await siembrasStore.getSiembra(id.value);
    cultivo.value = cultivos.value.find(
      (cultivo) => cultivo._id === siembra.Id_cultivo
    );
    responsable.value = siembra.Responsable;
