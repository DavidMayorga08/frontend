        ...
        <div class="cont">
          <div class="part1">
            ...
            <div class="cont_inputs">
              ...
              <input type="text" class="input" v-model="tipo" />
            </div>
            <div class="cont_inputs">
          ...
          <div class="part2">
            <div class="cont_inputs">
              <label for="fecha_siembra">Fecha de la siembra</label>
              <input type="Date" class="input" v-model="fecha_siembra" />
            </div>
            <div class="cont_inputs">
              <label for="variedad">Variedad</label>
              <input type="text" class="input" v-model="variedad" />
            </div>
            <div class="cont_imputs">
...
if (id.value) {
  titulo.value = "Editar Cultivo";
} else {
  titulo.value = "Crear Cultivo";
}
...
function validarCampos() {
  ...
  if (!tipo.value.trim()) {
    registroFallido.value = true;
    text.value = "El campo Tipo de cultivo no puede estar vacío";
    ocultar();
    return false;
  }
  if (parcela.value === "") {
  ...
  if (!fecha_siembra.value.trim()) {
    registroFallido.value = true;
    text.value = "El campo Fecha de la siembra no puede estar vacío";
    ocultar();
    return false;
  }
  if (!variedad.value.trim()) {
    registroFallido.value = true;
    text.value = "El campo Variedad no puede estar vacío";
    ocultar();
    return false;
  }
...
let enviar = async () => {
  ...
  if(id.value) {
    ...
    let cultivo = {
      ...
      Estado: estado.value,
      Hisotrial_modificacion: [modifica],
    }

    console.log(cultivo);
    await useCultivos.putCultivo(id.value, cultivo);
    spinner.value = false;
    registroExitoso.value = true;
    text.value = "Cultivo editado exitosamente";
    ocultar();
  } else {
    console.log("Crear");
    spinner.value = true;
    ...
    console.log(cultivo);
    await useCultivos.postCultivo(cultivo);
    spinner.value = false;
    registroExitoso.value = true;
    text.value = "Cultivo creado exitosamente";
    ocultar();
  }
}
...
onMounted(async () => {
  ...
  if(id.value) {
    let cultivo = await useCultivos.getCultivo(id.value);
    nombre.value = cultivo.Nombre;
    tipo.value = cultivo.Tipo;
    parcela.value = parcelas.value.find((parcela) => parcela._id === cultivo.Id_parcela);
    fecha_siembra.value = cultivo.Fecha_siembra.split("T")[0];
    variedad.value = cultivo.Variedad;
    estado.value = cultivo.Estado;
  }
  spinner.value = false;
});
</script>
