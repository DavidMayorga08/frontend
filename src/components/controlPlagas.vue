...
import { useControlPlagasStore } from "../stores/controlPlagas.js";
...
let crear = () => {
  router.push("/formControlPlagas");
};

let editar = (controlPlagas) => {
  let id = controlPlagas._id;
  router.push({ path: "/formControlPlagas", query: { id } });
};
