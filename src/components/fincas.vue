    ...
    <div class="cont_form">
      <div class="form">
        <div class="cont_titulo">
          <p class="titulo">Fincas</p>
        </div>
        <div class="cont_fincas">
          <select
            v-model="fincaOption"
            :class="{ placeholder: fincaOption === '' }"
          >
        ...
        <div class="cont_btn">
          <button class="btn" @click="Finca()">Seleccionar</button>
        </div>
      </div>
    </div>
...
let getFincas = async () => {
  spinner.value = true;
  fincasList.value = await fincas.getFincas();
  spinner.value = false;
};
...
let Finca = () => {
  if (fincaOption.value === "") {
    text.value = "Seleccione una finca";
    registroFallido.value = true;
    ocultar();
    return;
  } else {
    localStorage.setItem("Finca", fincaOption.value);
    router.push("/menu");
  }
};
